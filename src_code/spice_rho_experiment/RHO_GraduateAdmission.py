...
Reports:
  - Exact NUN recovery rate (% of queries where ANN found the true NUN)
  - Mean c    = HEOM(query, ANN_NUN) / HEOM(query, true_NUN)
  - Median c  (robust to outlier queries with near-zero true distance)
"""
...
SEMANTIC_WEIGHTS = np.array([
    355.5084, 268.6695, 177.0191,
    169.2294, 153.7180, 388.6553, 110.5969
])
...
def main():
    ...
    print("=" * 60)
    print("APPROXIMATION ERROR REPORT - Graduate Admission")
    print("=" * 60)
