...
Dataset: GMC (Give Me Some Credit)
...
SEMANTIC_WEIGHTS = np.array([
    0.2895, 1722.9974, 10328.1365, 10.9695, 44.0967,
    103.5971, 13770.3610, 12.5579, 9505.8989, 256.6856
])
...
def load_and_preprocess():
    ...
    neighbors_raw = combined[combined[TARGET_COL] == 1][FEATURE_COLUMNS].values

    all_negatives = combined[combined[TARGET_COL] == 0]
...
def main():
    ...
    print("=" * 60)
    print("APPROXIMATION ERROR REPORT - GMC")
    print("=" * 60)
