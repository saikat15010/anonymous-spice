...
Fresh MLPClassifier (matches dataset's saved model architecture).
...
def main():
    ...
    # Fresh MLP (matches saved model architecture)
    ...
    print("NOTE: HELOC has ~5K training points; this may take 10-30 minutes.\n")
    ...
    print("=" * 70)
    print("FACE Table 5 Results - HELOC (100 queries)")
    print("=" * 70)
    ...
    df.to_csv('table5_face_HELOC.csv', index=False)
    print(f"\nPer-query results saved to: table5_face_HELOC.csv")
