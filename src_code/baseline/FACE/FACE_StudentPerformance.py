...
Fresh LogisticRegression (matches dataset's saved model architecture).
...
# ============================================================
# FACE class (verbatim from working FACE.py)
# ============================================================
...
def main():
    ...
    # Fresh LogisticRegression (matches saved model architecture)
    ...
    print("=" * 70)
    print("FACE Table 5 Results - Student Performance (100 queries)")
    print("Reported as mean +/- std. FACE produces 1 CF per query.")
    print("=" * 70)
    ...
    df.to_csv('table5_face_StudentPerformance.csv', index=False)
    print(f"\nPer-query results saved to: table5_face_StudentPerformance.csv")
