...
Uses shap.TreeExplainer for the GradientBoostingClassifier model.
"""
...
def main():
    ...
    # ---- SHAP (TreeExplainer for GradientBoosting) ----
    ...
    print(f"SHAP class 1 weights (normalized):")
    ...
    print("=" * 70)
    print("PertCF Table 5 Results - Adult Income (100 queries)")
    print("=" * 70)
    ...
    df.to_csv('table5_pertcf_AdultIncome.csv', index=False)
    print(f"\nPer-query results saved to: table5_pertcf_AdultIncome.csv")
