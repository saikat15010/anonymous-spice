"""
VanillaCF Evaluation for Table 5 - GMC
"""
...
def main():
    ...
    print(f"Running VanillaCF on {n_take} queries (XGB predict_proba is fast)...")
    ...
    print("=" * 70)
    print("VanillaCF Table 5 Results - GMC (100 queries, 40 restarts)")
    print("=" * 70)
    ...
    df.to_csv('table5_vanillacf_GMC.csv', index=False)
    print(f"\nPer-query results saved to: table5_vanillacf_GMC.csv")
