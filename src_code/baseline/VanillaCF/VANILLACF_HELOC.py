"""
VanillaCF Evaluation for Table 5 - HELOC
"""
...
def main():
    ...
    print(f"Running VanillaCF on {n_take} queries (MLP predict_proba is slow)...")
    ...
    print("=" * 70)
    print("VanillaCF Table 5 Results - HELOC (100 queries, 40 restarts)")
    print("=" * 70)
    ...
    df.to_csv('table5_vanillacf_HELOC.csv', index=False)
    print(f"\nPer-query results saved to: table5_vanillacf_HELOC.csv")
