"""
VanillaCF Evaluation for Table 5 - Student Performance
Same protocol as Graduate Admission, with saved LR model and dataset configs.
"""
...
def main():
    ...
    print("=" * 70)
    print("VanillaCF Table 5 Results - Student Performance (100 queries, 40 restarts)")
    print("=" * 70)
    ...
    df.to_csv('table5_vanillacf_StudentPerformance.csv', index=False)
    print(f"\nPer-query results saved to: table5_vanillacf_StudentPerformance.csv")
