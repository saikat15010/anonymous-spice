...
# SHAP weights for HELOC
SEMANTIC_WEIGHTS = np.array([0.070893, 0.012939, 0.009626, 0.041815, 0.034078,
                             0.016024, 0.014264, 0.028888, 0.010051, 0.032914,
                             0.025819, 0.005463, 0.014264, 0.028089, 0.021328,
                             0.012237, 0.022605, 0.073963, 0.004239, 0.026032,
                             0.011008, 0.008890, 0.007442])
...
def main():
    ...
    print("=" * 70)
    print("WEIGHTED vs UNWEIGHTED - HELOC (SHAP, 100 queries)")
    print("=" * 70)
