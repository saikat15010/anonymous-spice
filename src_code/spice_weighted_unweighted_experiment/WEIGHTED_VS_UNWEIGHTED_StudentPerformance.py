...
# SHAP weights for Student Performance
SEMANTIC_WEIGHTS = np.array([0.457292, 0.016062, 0.098819, 0.141576, 0.068593,
                             0.103619, 0.224704, 0.105230, 0.144483, 0.109120,
                             0.021776, 0.289732, 1.338138, 3.372253])
...
def main():
    ...
    print("=" * 70)
    print("WEIGHTED vs UNWEIGHTED - Student Performance (SHAP, 100 queries)")
    print("=" * 70)
