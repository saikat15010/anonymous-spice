...
SEMANTIC_WEIGHTS = np.array([0.109711, 0.068366, 0.054120, 0.01979,
                             0.050907, 0.117970, 0.033994])
...
def load_everything():
    ...
    return combined, model, scaler, cat_idx, num_idx, ranges
...
def main():
    combined, model, scaler, cat_idx, num_idx, ranges = load_everything()
    ...
    all_neg = combined[combined['target'] == 0]
    ...
    print("=" * 70)
    print("WEIGHTED vs UNWEIGHTED - Graduate Admission (SHAP, 100 queries)")
    print("=" * 70)
