...
# Load dataset
combined_data = pd.read_csv('/Users/saikat/Desktop/Summer 2025/CFNet_AAAI_26/HELOC Dataset/AISTATS HELOC Dataset/heloc_dataset_v1.csv')
combined_data['target'] = combined_data['target'].map({'Bad': 0, 'Good': 1})
...
#semantic_weights = np.array([0.070893, 0.012939, 0.009626, 0.041815, 0.034078, 0.016024, 0.014264, 0.028888, 0.010051, 0.032914, 0.025819, 0.005463, 0.014264, 0.028089, 0.021328, 0.012237, 0.022605, 0.073963, 0.004239, 0.026032, 0.011008, 0.008890, 0.007442]) # SHAP Value
#semantic_weights = np.array([0.102001, 0.013669, 0.015964, 0.049370, 0.039125, 0.033673, 0.028263, 0.027385, 0.010993, 0.031454, 0.023752, 0.006040, 0.019638, 0.043020, 0.019443, 0.011117, 0.047565, 0.065786, 0.009126, 0.029636, 0.012059, 0.017091, 0.004771]) # LIME Score
#semantic_weights = np.array([0.116795, 0.022623, 0.000000, 0.039191, 0.023576, 0.023678, 0.020292, 0.047235, 0.034268, 0.039681, 0.034276, 0.021528, 0.000138, 0.012935, 0.035985, 0.008262, 0.006351, 0.065220, 0.001006, 0.019006, 0.006499, 0.044231, 0.042354]) # MI Score
semantic_weights = np.array([515.5929, 371.2184, 23.0887, 478.4414, 160.8467, 47.4515, 19.7351, 158.0204, 34.1658, 127.9533, 121.5765, 88.2948, 11.1589, 131.7401, 128.6771, 68.9996, 61.8160, 1020.4342, 73.6778, 26.3117, 6.499, 44.231, 42.354]) # ANOVA Test Score
