...
query_instance = {'GRE Score': 314.0, 'TOEFL Score': 102.0, 'University Rating': 4.0, 'SOP': 2.5, 'LOR': 2.0, 'CGPA': 7.88, 'Research': 1.0}

nun_instance   = {'GRE Score': 323.0, 'TOEFL Score': 107.0, 'University Rating': 4.0, 'SOP': 3.0, 'LOR': 2.5, 'CGPA': 8.48, 'Research': 1.0}
...
important_features = [f for f in ['GRE Score', 'TOEFL Score', 'University Rating', 'SOP', 'CGPA', 'LOR', 'Research'] if f not in immutable_features]

# Define categorical and numerical features
categorical_features = [f for f in ['University Rating'] if f not in immutable_features]
numerical_features = [f for f in ['GRE Score', 'TOEFL Score', 'SOP', 'LOR', 'CGPA', 'Research'] if f not in immutable_features]
...
def find_best_candidate(counterfactual_candidates, query_instance, feature_order, lambda_value=1.0):
