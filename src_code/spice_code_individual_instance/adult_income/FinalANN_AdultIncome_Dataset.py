...
# Load dataset
combined_data  = pd.read_csv('/Users/saikat/Desktop/Summer 2025/CFNet_AAAI_26/Adult Income Dataset/processed_adult.csv')
...
feature_columns = ['age', 'workclass', 'fnlwgt', 'education', 'educational-num', 'marital-status', 'occupation', 'relationship', 'race', 'gender', 'capital-gain', 'capital-loss', 'hours-per-week', 'native-country']
...
#semantic_weights = np.array([0.546833, 0.062240, 0.071102, 0.022808, 0.470401, 0.228216, 0.271241, 0.978600, 0.032014, 0.126574, 0.454561, 0.124117, 0.297832, 0.030739]) # SHAP Method

#semantic_weights = np.array([0.746599, 0.057077, 0.031928, 0.022926, 0.017415, 0.013765, 0.010968, 0.008879, 0.007059, 0.005514, 0.003976, 0.002518, 0.001171, 0.0000001])# LIME Method

#semantic_weights = np.array([0.066420, 0.015710, 0.020643, 0.064756, 0.063943, 0.108260, 0.062931, 0.116516, 0.007173 , 0.028532, 0.084514, 0.035128, 0.038397, 0.006241]) # MI Method

semantic_weights = np.array([2021.1135, 3.5984, 1.8878, 240.5079, 4399.2564, 1349.7858, 86.8274, 2381.2899, 175.5655, 1708.3080, 1816.0313, 770.3146, 1866.2539, 21.3586]) # ANOVA Method
