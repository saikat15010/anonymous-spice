...
query_instance = {'age': 43, 'workclass': 2, 'fnlwgt': 128354, 'education': 11, 'educational-num': 9, 'marital-status': 2, 'occupation': 0, 'relationship': 5, 'race': 4, 'gender': 0, 'capital-gain': 0, 'capital-loss': 0, 'hours-per-week': 30, 'native-country': 38}

nun_instance   = {'age': 43, 'workclass': 2, 'fnlwgt': 105936, 'education': 11, 'educational-num': 9, 'marital-status': 2, 'occupation': 0, 'relationship': 5, 'race': 4, 'gender': 0, 'capital-gain': 0, 'capital-loss': 0, 'hours-per-week': 35, 'native-country': 38}
...
important_features = [f for f in ['age', 'workclass', 'fnlwgt', 'education', 'educational-num', 'marital-status', 'occupation', 'relationship', 'race', 'gender', 'capital-gain', 'capital-loss', 'hours-per-week', 'native-country'] if f not in immutable_features]


# Define categorical and numerical features
categorical_features = [f for f in ['workclass', 'education', 'marital-status', 'occupation', 'relationship', 'race', 'gender', 'native-country'] if f not in immutable_features]
numerical_features = [f for f in ['age', 'fnlwgt', 'educational-num', 'capital-gain', 'capital-loss', 'hours-per-week'] if f not in immutable_features]
...
feature_order =  ['age', 'workclass', 'fnlwgt', 'education', 'educational-num', 'marital-status', 'occupation', 'relationship', 'race', 'gender', 'capital-gain', 'capital-loss', 'hours-per-week', 'native-country']
