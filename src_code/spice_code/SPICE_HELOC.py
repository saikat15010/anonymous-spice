...
Protocol:
  ...
  - NUN pool and query pool filtered by MODEL PREDICTION (not ground-truth)
...
SEMANTIC_WEIGHTS = np.array([0.102001, 0.013669, 0.015964, 0.049370, 0.039125,
                             0.033673, 0.028263, 0.027385, 0.010993, 0.031454,
                             0.023752, 0.006040, 0.019638, 0.043020, 0.019443,
                             0.011117, 0.047565, 0.065786, 0.009126, 0.029636,
                             0.012059, 0.017091, 0.004771])
...
def main():
    ...
    print("=" * 70)
    print("SPICE Table 5 Results - HELOC (LIME, 100 queries)")
    ...
    df.to_csv('table5_spice_HELOC.csv', index=False)
    print(f"\nPer-query results saved to: table5_spice_HELOC.csv")
