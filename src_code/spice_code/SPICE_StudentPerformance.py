...
SEMANTIC_WEIGHTS = np.array([0.444669, 0.134395, 0.055798, 0.039417, 0.031119,
                             0.025958, 0.020544, 0.016677, 0.012975, 0.009311,
                             0.006075, 0.002890, 0.000001, 0.000001])
...
def main():
    ...
    print("=" * 70)
    print("SPICE Table 5 Results - Student Performance (LIME, 100 queries)")
    ...
    df.to_csv('table5_spice_StudentPerformance.csv', index=False)
    print(f"\nPer-query results saved to: table5_spice_StudentPerformance.csv")
